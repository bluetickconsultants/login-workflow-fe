      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 dark:text-gray-200">Explore the solutions</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            {/* 1st item */}
            <div className="relative flex flex-col items-center p-6 bg-white dark:bg-stone-500/20 rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1 dark:text-gray-200">Headless CMS</h4>
              <p className="text-gray-600 text-center dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
